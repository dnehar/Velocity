...
source activate velo #- python environement with needed dependencies (h5py 2.9.0, loompy 3.0.6)
...
-o /projects/nehard/SingleCell/Velocity/output/ \  #- output where the loom file will be saved 
